...
namespace faith
{
	...
	// [A-Z], [a-z], [0-9], [ + ], [ / ]
	const unsigned char base64::ms_aucBase64Char[65] = 
	{
	...
	const unsigned char base64::ms_aucBase64ToBit6[128] = 
	{
	...
	char* base64::encode(const void* pvSrcBinaryBuffer,
	...
	bool base64::decode(void* pvDestBinaryBuffer, 
		const char* pcSrcBase64Ascii, size_t& stBytesWritten)
	{
		...
		size_t iSetsOf4Base64Bytes = szStrLen >> 2; 
		...
		for(size_t i=0; i<iSetsOf4Base64Bytes; i++)
		{   
