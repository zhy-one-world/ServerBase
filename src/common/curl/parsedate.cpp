...
const char * const faith_Curl_wkday[] =
{"Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"};
static const char * const weekday[] =
{ "Monday", "Tuesday", "Wednesday", "Thursday",
  "Friday", "Saturday", "Sunday" };
const char * const faith_Curl_month[]=
...
time_t faith_curl_getdate(const char *p, const time_t *now)
{
  time_t parsed;
