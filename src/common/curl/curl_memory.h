 ...
 * memory callbacks, at runtime with faith_curl_global_init_mem()
 *
...
extern faith_curl_malloc_callback faith_Curl_cmalloc;
extern faith_curl_free_callback faith_Curl_cfree;
extern faith_curl_realloc_callback faith_Curl_crealloc;
extern faith_curl_strdup_callback faith_Curl_cstrdup;
extern faith_curl_calloc_callback faith_Curl_ccalloc;
...
#undef strdup
#define strdup(ptr) faith_Curl_cstrdup(ptr)
#undef malloc
//#define malloc(size) faith_Curl_cmalloc(size)
#undef calloc
//#define calloc(nbelem,size) faith_Curl_ccalloc(nbelem, size)
#undef realloc
//#define realloc(ptr,size) faith_Curl_crealloc(ptr, size)
#undef free
#define free(ptr) faith_Curl_cfree(ptr)
...
#  else
#    undef _tcsdup
#    define _tcsdup(ptr) faith_Curl_cstrdup(ptr)
#  endif
#endif
