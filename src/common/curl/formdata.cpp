 ...
 * faith_curl_formadd (&post, &last, CURLFORM_COPYNAME, "name",
...
/*
 * faith_curl_formadd() is a public API to add a section to the multipart formpost.
 *
 * @unittest: 1308
 */

CURLFORMcode faith_curl_formadd(struct curl_httppost **httppost,
                          struct curl_httppost **last_post,
                          ...)
{
  va_list arg;
 ...
 * @unittest: 1308
 */
int faith_curl_formget(struct curl_httppost *form, void *arg,
...
/*
 * faith_curl_formfree() is an external function to free up a whole form post
 * chain
 */
void faith_curl_formfree(struct curl_httppost *form)
{
